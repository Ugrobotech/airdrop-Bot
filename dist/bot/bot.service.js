    ...
    constructor(databaseService) {
        ...
        this.onReceiveMessage = async (msg) => {
            ...
            try {
                ...
                console.log(...oo_oo(`3595378573_72_6_72_39_4`, 'command :', command));
                if (command === '/start') {
        ...
        this.checkDone = async (chatId, userId) => {
            ...
            console.log(...oo_oo(`3595378573_353_4_353_28_4`, 'I am here'));
            try {
                const groupId = -1002116374739;
                const user_Id = userId;
                console.log(...oo_oo(`3595378573_359_6_359_39_4`, 'user id :', user_Id));
                const chat_Id = +chatId;
                console.log(...oo_oo(`3595378573_361_6_361_39_4`, 'chat id :', chat_Id));
                let isMember;
                this.bot
                    ...
                    if (member.status === 'member' ||
                        ...
                        isMember = true;
                        console.log(...oo_oo(`3595378573_375_12_375_50_4`, 'status :', member.status));
                    }
                    else {
                        isMember = false;
                    }
                    ...
                    if (e.response.body.error_code == 400) {
                        console.log(...oo_oo(`3595378573_382_12_382_60_4`, 'does not exist :', e.response.body));
                        isMember = false;
                    }
                });
                ...
                console.log(...oo_oo(`3595378573_390_6_390_42_4`, 'is member :', isMember));
                ...
                console.log(...oo_oo(`3595378573_403_6_403_24_4`, error));
            }
        };
        ...
        this.handleButtonCommands = async (query) => {
            ...
            console.log(...oo_oo(`3595378573_509_4_509_24_4`, command));
            console.log(...oo_oo(`3595378573_510_4_510_26_4`, airdropId));
            console.log(...oo_oo(`3595378573_511_4_511_31_4`, userId, chatId));
            try {
                switch (command) {
                    case '/getstarted':
                    ...
                    case '/add_to_wishlist':
                        ...
                        if (userDbId) {
                            try {
                                console.log(...oo_oo(`3595378573_565_14_565_35_4`, userDbId));
                    ...
                    case '/removefrom_wishlist':
                        ...
                        if (userDbId3) {
                            try {
                                ...
                                console.log(...oo_oo(`3595378573_607_14_607_54_4`, 'airdrop to del :', airdrop));
                                if (airdrop) {
                                ...
                                console.log(...oo_oo(`3595378573_625_14_625_32_4`, error));
                            }
                            break;
                        }
                        break;
    ...
    ${network}.\n${details}.\n\n\t${steps}\n\n\tCost: ${cost}`;
            ...
            try {
                ...
                if (message) {
                    ...
                    if (wishLists) {
                        ...
                        console.log(...oo_oo(`3595378573_887_10_887_45_4`, 'db2: ', wishListArray));
        ...
        this.removeFromWishlist = async (airdrop_Id, owner_Id) => {
            try {
                ...
                console.log(...oo_oo(`3595378573_937_6_937_35_4`, 'exist :', exist));
                if (exist) {
