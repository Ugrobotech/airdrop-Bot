...
let BotService = BotService_1 = class BotService {
    constructor(databaseService) {
        ...
        this.sendWelcomeMenu = async (chatId) => {
            ...
            try {
                return await this.sendPictureToUser(chatId, 'https://images.pexels.com/photos/210600/pexels-photo-210600.jpeg?auto=compress&cs=tinysrgb&w=600', 'Welcome👋! to AirdropScanBot @SkyDrip_bot.', replyMarkup);
            }
            catch (error) {
                console.error(error);
            }
        ...
        this.handleButtonCommands = async (query) => {
            ...
            console.log(...oo_oo(`1733252309_321_4_321_24_4`, command));
            try {
                switch (command) {
                    case '/hottest':
                        const hottest = await this.sendHottestAirdrops(chatId);
