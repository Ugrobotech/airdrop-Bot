...
let BotService = BotService_1 = class BotService {
    constructor(databaseService) {
        ...
        this.sendPictureToUser = async (userId, imageUrl, message) => {
            try {
        ...
        this.sendMainMenu = async (chatId) => {
            ...
            try {
                const welcome = await this.sendPictureToUser(chatId, 'https://images.pexels.com/photos/210600/pexels-photo-210600.jpeg?auto=compress&cs=tinysrgb&w=600', 'Welcome👋! to AirdropScanBot @SkyDrip_bot.');
                if (welcome) {
                ...
                switch (command) {
                    ...
                    case '/latest':
                        ...
                        if (latest)
                            break;
                    case '/subscribe':
                        return await this.sendPictureToUser(chatId, 'https://images.pexels.com/photos/210600/pexels-photo-210600.jpeg?auto=compress&cs=tinysrgb&w=600', 'picture');
                        break;
                    case '/unsubscribe':
        ...
        this.handleButtonCommands = async (query) => {
            ...
            console.log(...oo_oo(`2197797592_318_4_318_24_4`, command));
            try {
                switch (command) {
                    case '/hottest':
                        const hottest = await this.sendHottestAirdrops(chatId);
