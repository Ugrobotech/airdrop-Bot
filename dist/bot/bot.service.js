    ...
    constructor(databaseService) {
        ...
        this.onReceiveMessage = async (msg) => {
            ...
            try {
                ...
                console.log(...oo_oo(`793162533_72_6_72_39_4`, 'command :', command));
                if (command === '/start') {
        ...
        this.checkDone = async (chatId, userId) => {
            ...
            console.log(...oo_oo(`793162533_293_4_293_28_4`, 'I am here'));
            try {
                const groupId = -1002136597023;
                const user_Id = userId;
                console.log(...oo_oo(`793162533_299_6_299_39_4`, 'user id :', user_Id));
                const chat_Id = +chatId;
                console.log(...oo_oo(`793162533_301_6_301_39_4`, 'chat id :', chat_Id));
                let isMember;
                this.bot
                    ...
                    if (member.status === 'member' ||
                        ...
                        isMember = true;
                        console.log(...oo_oo(`793162533_315_12_315_50_4`, 'status :', member.status));
                    }
                    else {
                        isMember = false;
                    }
                    ...
                    if (e.response.body.error_code == 400) {
                        console.log(...oo_oo(`793162533_322_12_322_60_4`, 'does not exist :', e.response.body));
                        isMember = false;
                    }
                });
                ...
                console.log(...oo_oo(`793162533_330_6_330_42_4`, 'is member :', isMember));
                ...
                console.log(...oo_oo(`793162533_343_6_343_24_4`, error));
            }
        };
        ...
        this.handleButtonCommands = async (query) => {
            ...
            console.log(...oo_oo(`793162533_426_4_426_22_4`, query));
            console.log(...oo_oo(`793162533_427_4_427_31_4`, userId, chatId));
            try {
                switch (command) {
                    case '/getstarted':
