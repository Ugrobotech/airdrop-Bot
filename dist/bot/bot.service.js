    ...
    constructor(databaseService) {
        ...
        this.onReceiveMessage = async (msg) => {
            ...
            try {
                ...
                console.log(...oo_oo(`3791970925_73_6_73_39_4`, 'command :', command));
                if (command === '/start') {
                ...
                if (users && message) {
                    const sendALL = users.map(async (user) => {
                        try {
                            ...
                            console.log(...oo_oo(`3791970925_209_12_209_30_4`, error));
                        }
                    });
                    return sendALL;
                }
                ...
                if (users && message) {
                    const sendALL = users.map(async (user) => {
                        try {
                            ...
                            console.log(...oo_oo(`3791970925_258_12_258_30_4`, error));
                        }
                    });
                    return sendALL;
                }
        ...
        this.checkDone = async (chatId, userId) => {
            ...
            console.log(...oo_oo(`3791970925_377_4_377_28_4`, 'I am here'));
            try {
                const groupId = -1002116374739;
                const user_Id = userId;
                console.log(...oo_oo(`3791970925_383_6_383_39_4`, 'user id :', user_Id));
                const chat_Id = +chatId;
                console.log(...oo_oo(`3791970925_385_6_385_39_4`, 'chat id :', chat_Id));
                let isMember;
                this.bot
                    ...
                    if (member.status === 'member' ||
                        ...
                        isMember = true;
                        console.log(...oo_oo(`3791970925_399_12_399_50_4`, 'status :', member.status));
                    }
                    else {
                        isMember = false;
                    }
                    ...
                    if (e.response.body.error_code == 400) {
                        console.log(...oo_oo(`3791970925_406_12_406_60_4`, 'does not exist :', e.response.body));
                        isMember = false;
                    }
                });
                ...
                console.log(...oo_oo(`3791970925_414_6_414_42_4`, 'is member :', isMember));
                ...
                console.log(...oo_oo(`3791970925_427_6_427_24_4`, error));
            }
        };
        ...
        this.handleButtonCommands = async (query) => {
            ...
            console.log(...oo_oo(`3791970925_534_4_534_24_4`, command));
            console.log(...oo_oo(`3791970925_535_4_535_26_4`, airdropId));
            console.log(...oo_oo(`3791970925_536_4_536_31_4`, userId, chatId));
            try {
                switch (command) {
                    case '/getstarted':
                    ...
                    case '/add_to_wishlist':
                        ...
                        if (userDbId) {
                            try {
                                console.log(...oo_oo(`3791970925_590_14_590_35_4`, userDbId));
                    ...
                    case '/removefrom_wishlist':
                        ...
                        if (userDbId3) {
                            try {
                                ...
                                console.log(...oo_oo(`3791970925_632_14_632_54_4`, 'airdrop to del :', airdrop));
                                if (airdrop) {
                                ...
                                console.log(...oo_oo(`3791970925_650_14_650_32_4`, error));
                            }
                            break;
                        }
                        break;
    ...
    ${network}.\n${details}.\n\n\t${steps}\n\n\tCost: ${cost}`;
            ...
            try {
                ...
                if (message) {
                    ...
                    if (wishLists) {
                        ...
                        console.log(...oo_oo(`3791970925_911_10_911_45_4`, 'db2: ', wishListArray));
        ...
        this.removeFromWishlist = async (airdrop_Id, owner_Id) => {
            try {
                ...
                console.log(...oo_oo(`3791970925_961_6_961_35_4`, 'exist :', exist));
                if (exist) {
