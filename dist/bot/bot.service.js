    ...
    constructor(databaseService) {
        ...
        this.onReceiveMessage = async (msg) => {
            ...
            try {
                ...
                console.log(...oo_oo(`3925683834_72_6_72_39_4`, 'command :', command));
                if (command === '/start') {
        ...
        this.checkDone = async (chatId, userId) => {
            ...
            console.log(...oo_oo(`3925683834_294_4_294_28_4`, 'I am here'));
            try {
                const groupId = -1002116374739;
                const user_Id = userId;
                console.log(...oo_oo(`3925683834_300_6_300_39_4`, 'user id :', user_Id));
                const chat_Id = +chatId;
                console.log(...oo_oo(`3925683834_302_6_302_39_4`, 'chat id :', chat_Id));
                let isMember;
                this.bot
                    ...
                    if (member.status === 'member' ||
                        ...
                        isMember = true;
                        console.log(...oo_oo(`3925683834_316_12_316_50_4`, 'status :', member.status));
                    }
                    else {
                        isMember = false;
                    }
                    ...
                    if (e.response.body.error_code == 400) {
                        console.log(...oo_oo(`3925683834_323_12_323_60_4`, 'does not exist :', e.response.body));
                        isMember = false;
                    }
                });
                ...
                console.log(...oo_oo(`3925683834_331_6_331_42_4`, 'is member :', isMember));
                ...
                console.log(...oo_oo(`3925683834_344_6_344_24_4`, error));
            }
        };
        ...
        this.handleButtonCommands = async (query) => {
            ...
            console.log(...oo_oo(`3925683834_427_4_427_22_4`, query));
            console.log(...oo_oo(`3925683834_428_4_428_31_4`, userId, chatId));
            try {
                switch (command) {
                    case '/getstarted':
        ...
        this.sendAirdropDetails = async (chatId, imageUrl, airdropName, network, details, category, steps, cost) => {
            const keyboard = [
                [{ text: 'Add to wishList 🛒', callback_data: '/add_to_wishlist' }],
            ];
            const replyMarkup = {
                inline_keyboard: keyboard,
            };
