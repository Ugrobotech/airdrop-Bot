...
let BotService = BotService_1 = class BotService {
    constructor(databaseService) {
        ...
        this.onReceiveMessage = async (msg) => {
            ...
            try {
                ...
                console.log(...oo_oo(`1335839857_72_6_72_39_4`, 'command :', command));
                if (command === '/start') {
        ...
        this.checkDone = async (chatId, userId) => {
            ...
            console.log(...oo_oo(`1335839857_315_4_315_28_4`, 'I am here'));
            try {
                const groupId = -1002116374739;
                const user_Id = userId;
                console.log(...oo_oo(`1335839857_321_6_321_39_4`, 'user id :', user_Id));
                const chat_Id = +chatId;
                console.log(...oo_oo(`1335839857_323_6_323_39_4`, 'chat id :', chat_Id));
                let isMember;
                this.bot
                    ...
                    if (member.status === 'member' ||
                        ...
                        isMember = true;
                        console.log(...oo_oo(`1335839857_337_12_337_50_4`, 'status :', member.status));
                    }
                    else {
                        isMember = false;
                    }
                    ...
                    if (e.response.body.error_code == 400) {
                        console.log(...oo_oo(`1335839857_344_12_344_60_4`, 'does not exist :', e.response.body));
                        isMember = false;
                    }
                });
                ...
                console.log(...oo_oo(`1335839857_352_6_352_42_4`, 'is member :', isMember));
                ...
                console.log(...oo_oo(`1335839857_365_6_365_24_4`, error));
            }
        };
        ...
        this.handleButtonCommands = async (query) => {
            ...
            console.log(...oo_oo(`1335839857_466_4_466_24_4`, command));
            console.log(...oo_oo(`1335839857_467_4_467_26_4`, airdropId));
            console.log(...oo_oo(`1335839857_468_4_468_31_4`, userId, chatId));
            try {
                switch (command) {
                    case '/getstarted':
                    ...
                    case '/add_to_wishlist':
                        ...
                        if (userDbId) {
                            try {
                                console.log(...oo_oo(`1335839857_522_14_522_35_4`, userDbId));
                    ...
                    case '/view_wishlist':
                        ...
                        if (userDbId2) {
                            try {
                                console.log(...oo_oo(`1335839857_557_14_557_45_4`, 'db2: ', userDbId2));
                                ...
                                console.log(...oo_oo(`1335839857_566_14_566_35_4`, wishlist));
                                if (wishlist) {
                                    return this.bot.sendMessage(chatId, 'Successfully added to Wishlist');
                                }
                                else {
                                    return this.bot.sendMessage(chatId, 'Sorry there was error while adding to wishlist');
                                }
                            }
                            catch (error) { }
                            break;
    ...
    ${network}.\n${details}.\n\n\t${steps}\n\n\tCost: ${cost}`;
        ...
        this.addToWishlist = async (airdropId) => {
            try {
