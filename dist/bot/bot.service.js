    ...
    constructor(databaseService) {
        ...
        this.onReceiveMessage = async (msg) => {
            ...
            try {
                ...
                console.log(...oo_oo(`1599213036_73_6_73_39_4`, 'command :', command));
                if (command === '/start') {
                ...
                if (users && message) {
                    const sendALL = users.map(async (user) => {
                        try {
                            ...
                            console.log(...oo_oo(`1599213036_209_12_209_30_4`, error));
                        }
                    });
                    return sendALL;
                }
                ...
                if (users && message) {
                    const sendALL = users.map(async (user) => {
                        try {
                            ...
                            console.log(...oo_oo(`1599213036_258_12_258_30_4`, error));
                        }
                    });
                    return sendALL;
                }
        ...
        this.checkDone = async (chatId, userId) => {
            ...
            console.log(...oo_oo(`1599213036_377_4_377_28_4`, 'I am here'));
            try {
                const groupId = -1002116374739;
                const user_Id = userId;
                console.log(...oo_oo(`1599213036_383_6_383_39_4`, 'user id :', user_Id));
                const chat_Id = +chatId;
                console.log(...oo_oo(`1599213036_385_6_385_39_4`, 'chat id :', chat_Id));
                let isMember;
                this.bot
                    ...
                    if (member.status === 'member' ||
                        ...
                        isMember = true;
                        console.log(...oo_oo(`1599213036_399_12_399_50_4`, 'status :', member.status));
                    }
                    else {
                        isMember = false;
                    }
                    ...
                    if (e.response.body.error_code == 400) {
                        console.log(...oo_oo(`1599213036_406_12_406_60_4`, 'does not exist :', e.response.body));
                        isMember = false;
                    }
                });
                ...
                console.log(...oo_oo(`1599213036_414_6_414_42_4`, 'is member :', isMember));
                ...
                console.log(...oo_oo(`1599213036_427_6_427_24_4`, error));
            }
        };
        ...
        this.handleButtonCommands = async (query) => {
            ...
            console.log(...oo_oo(`1599213036_533_4_533_24_4`, command));
            console.log(...oo_oo(`1599213036_534_4_534_26_4`, airdropId));
            console.log(...oo_oo(`1599213036_535_4_535_31_4`, userId, chatId));
            try {
                switch (command) {
                    case '/getstarted':
                    ...
                    case '/add_to_wishlist':
                        ...
                        if (userDbId) {
                            try {
                                console.log(...oo_oo(`1599213036_589_14_589_35_4`, userDbId));
                    ...
                    case '/removefrom_wishlist':
                        ...
                        if (userDbId3) {
                            try {
                                ...
                                console.log(...oo_oo(`1599213036_631_14_631_54_4`, 'airdrop to del :', airdrop));
                                if (airdrop) {
                                ...
                                console.log(...oo_oo(`1599213036_649_14_649_32_4`, error));
                            }
                            break;
                        }
                        break;
    ...
    ${network}.\n${details}.\n\n\t${steps}\n\n\tCost: ${cost}`;
            ...
            try {
                ...
                if (message) {
                    ...
                    if (wishLists) {
                        ...
                        console.log(...oo_oo(`1599213036_910_10_910_45_4`, 'db2: ', wishListArray));
        ...
        this.removeFromWishlist = async (airdrop_Id, owner_Id) => {
            try {
                ...
                console.log(...oo_oo(`1599213036_960_6_960_35_4`, 'exist :', exist));
                if (exist) {
