    ...
    constructor(databaseService) {
        ...
        this.onReceiveMessage = async (msg) => {
            ...
            try {
                ...
                console.log(...oo_oo(`564965972_74_6_74_39_4`, 'command :', command));
                if (command === '/start') {
                ...
                if (users && message) {
                    const sendALL = users.map(async (user) => {
                        try {
                            ...
                            console.log(...oo_oo(`564965972_210_12_210_30_4`, error));
                        }
                    });
                    return sendALL;
                }
                ...
                if (users && message) {
                    const sendALL = users.map(async (user) => {
                        try {
                            ...
                            console.log(...oo_oo(`564965972_259_12_259_30_4`, error));
                        }
                    });
                    return sendALL;
                }
        ...
        this.checkDone = async (chatId, userId) => {
            ...
            console.log(...oo_oo(`564965972_379_4_379_28_4`, 'I am here'));
            try {
                const groupId = -1002116374739;
                const user_Id = userId;
                console.log(...oo_oo(`564965972_385_6_385_39_4`, 'user id :', user_Id));
                const chat_Id = +chatId;
                console.log(...oo_oo(`564965972_387_6_387_39_4`, 'chat id :', chat_Id));
                let isMember;
                this.bot
                    ...
                    if (member.status === 'member' ||
                        ...
                        isMember = true;
                        console.log(...oo_oo(`564965972_401_12_401_50_4`, 'status :', member.status));
                    }
                    else {
                        isMember = false;
                    }
                    ...
                    if (e.response.body.error_code == 400) {
                        console.log(...oo_oo(`564965972_408_12_408_60_4`, 'does not exist :', e.response.body));
                        isMember = false;
                    }
                });
                ...
                console.log(...oo_oo(`564965972_416_6_416_42_4`, 'is member :', isMember));
                ...
                console.log(...oo_oo(`564965972_429_6_429_24_4`, error));
            }
        };
        ...
        this.handleButtonCommands = async (query) => {
            ...
            console.log(...oo_oo(`564965972_544_4_544_24_4`, command));
            console.log(...oo_oo(`564965972_545_4_545_26_4`, airdropId));
            console.log(...oo_oo(`564965972_546_4_546_31_4`, userId, chatId));
            try {
                switch (command) {
                    case '/getstarted':
                    ...
                    case '/add_to_wishlist':
                        ...
                        if (userDbId) {
                            try {
                                console.log(...oo_oo(`564965972_604_14_604_35_4`, userDbId));
                    ...
                    case '/removefrom_wishlist':
                        ...
                        if (userDbId3) {
                            try {
                                ...
                                console.log(...oo_oo(`564965972_646_14_646_54_4`, 'airdrop to del :', airdrop));
                                if (airdrop) {
                                ...
                                console.log(...oo_oo(`564965972_664_14_664_32_4`, error));
                            }
                            break;
                        }
                        break;
    ...
    ${network}.\n${details}.\n\n\t${steps}\n\n\tCost: ${cost}`;
            ...
            try {
                ...
                if (message) {
                    ...
                    if (wishLists) {
                        ...
                        console.log(...oo_oo(`564965972_926_10_926_45_4`, 'db2: ', wishListArray));
        ...
        this.removeFromWishlist = async (airdrop_Id, owner_Id) => {
            try {
                ...
                console.log(...oo_oo(`564965972_976_6_976_35_4`, 'exist :', exist));
                if (exist) {
        ...
        this.sendAvailableChains = async (chatId) => {
            try {
                ...
                console.log(...oo_oo(`564965972_1021_6_1021_24_4`, error));
            }
        };
