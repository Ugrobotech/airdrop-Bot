    ...
    constructor(databaseService) {
        ...
        this.onReceiveMessage = async (msg) => {
            ...
            try {
                ...
                console.log(...oo_oo(`3432337673_72_6_72_39_4`, 'command :', command));
                if (command === '/start') {
        ...
        this.checkDone = async (chatId, userId) => {
            ...
            console.log(...oo_oo(`3432337673_315_4_315_28_4`, 'I am here'));
            try {
                const groupId = -1002116374739;
                const user_Id = userId;
                console.log(...oo_oo(`3432337673_321_6_321_39_4`, 'user id :', user_Id));
                const chat_Id = +chatId;
                console.log(...oo_oo(`3432337673_323_6_323_39_4`, 'chat id :', chat_Id));
                let isMember;
                this.bot
                    ...
                    if (member.status === 'member' ||
                        ...
                        isMember = true;
                        console.log(...oo_oo(`3432337673_337_12_337_50_4`, 'status :', member.status));
                    }
                    else {
                        isMember = false;
                    }
                    ...
                    if (e.response.body.error_code == 400) {
                        console.log(...oo_oo(`3432337673_344_12_344_60_4`, 'does not exist :', e.response.body));
                        isMember = false;
                    }
                });
                ...
                console.log(...oo_oo(`3432337673_352_6_352_42_4`, 'is member :', isMember));
                ...
                console.log(...oo_oo(`3432337673_365_6_365_24_4`, error));
            }
        };
        ...
        this.handleButtonCommands = async (query) => {
            ...
            console.log(...oo_oo(`3432337673_471_4_471_24_4`, command));
            console.log(...oo_oo(`3432337673_472_4_472_26_4`, airdropId));
            console.log(...oo_oo(`3432337673_473_4_473_31_4`, userId, chatId));
            try {
                switch (command) {
                    case '/getstarted':
                    ...
                    case '/add_to_wishlist':
                        ...
                        if (userDbId) {
                            try {
                                console.log(...oo_oo(`3432337673_527_14_527_35_4`, userDbId));
                    ...
                    case '/removefrom_wishlist':
                        ...
                        if (userDbId3) {
                            try {
                                ...
                                console.log(...oo_oo(`3432337673_569_14_569_54_4`, 'airdrop to del :', airdrop));
                                if (airdrop) {
                                ...
                                console.log(...oo_oo(`3432337673_587_14_587_32_4`, error));
                            }
                            break;
                        }
                        break;
    ...
    ${network}.\n${details}.\n\n\t${steps}\n\n\tCost: ${cost}`;
            ...
            try {
                ...
                if (message) {
                    ...
                    if (wishLists) {
                        ...
                        console.log(...oo_oo(`3432337673_849_10_849_45_4`, 'db2: ', wishListArray));
        ...
        this.removeFromWishlist = async (airdrop_Id, owner_Id) => {
            try {
                ...
                console.log(...oo_oo(`3432337673_899_6_899_35_4`, 'exist :', exist));
                if (exist) {
