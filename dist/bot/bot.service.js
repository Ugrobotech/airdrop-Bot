    ...
    constructor(databaseService) {
        ...
        this.onReceiveMessage = async (msg) => {
            ...
            try {
                ...
                console.log(...oo_oo(`3818628598_72_6_72_39_4`, 'command :', command));
                if (command === '/start') {
        ...
        this.checkDone = async (chatId, userId) => {
            ...
            console.log(...oo_oo(`3818628598_298_4_298_28_4`, 'I am here'));
            try {
                ...
                console.log(...oo_oo(`3818628598_331_6_331_24_4`, error));
            }
        };
        ...
        this.handleButtonCommands = async (query) => {
            ...
            console.log(...oo_oo(`3818628598_401_4_401_22_4`, query));
            console.log(...oo_oo(`3818628598_402_4_402_31_4`, userId, chatId));
            try {
                switch (command) {
                    case '/getstarted':
